  ...
  return useState('places', () => {
    const data = [
      ...
      },
      {
        id: 24,
        name: 'Baogo',
        photo: 'https://v2cdn1.centralappstatic.com/file/logo_3b8f6d832aa644758f3efa371084f105.svg',
        photoBlack: true,
        ...
        link: 'https://baogo.be/en',
        when: 'dinner',
      },
      {
        id: 25,
        name: 'Bambou Sushi Bar',
        photo: 'https://www.bambousushi.be/wp-content/uploads/2021/01/Logo-carrer-rond-pour-fond-claire-120_134_v2.png',
        city: 'Brussels, Belgium',
        flag: 'be',
        total: 0,
        votes: {
        ...
        link: 'https://www.bambousushi.be',
        when: 'dinner',
      },
      {
        id: 26,
        name: 'Mozart, More Than Just Ribs',
        photo: 'https://mozart-resto.be/wp-content/uploads/2017/12/Logo1-vierkant.png',
        city: 'Brussels, Belgium',
        flag: 'be',
        total: 0,
        votes: {
